...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the system font for the TextView
       // textview.setTypeface(null, Typeface.SANS_SERIFA);
        ...
        GoogleSignInOptions googleSignInOptions=new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestIdToken("219710697048-thp7l6ovjin3d3rcv16m2ettlnrpg4s6.apps.googleusercontent.com").requestEmail().build();
        ...
        {
            startActivity(new Intent(MainActivity.this,videoimageplayer.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    @Override
                                    ...
                                    FirebaseDatabase.getInstance().getReference().child("users").child(FirebaseAuth.getInstance().getUid()).setValue(u).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                FirebaseDatabase.getInstance().getReference().child(FirebaseAuth.getInstance().getUid()+"friends").child(FirebaseAuth.getInstance().getUid()).setValue(f);
                                            } else {
                                            }
                                        }
                                    });
