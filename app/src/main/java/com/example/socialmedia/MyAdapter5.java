...
public class MyAdapter5 extends RecyclerView.Adapter<productviewholder5> {
    ...
    @Override public productviewholder5 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override public void onBindViewHolder(@NonNull productviewholder5 holder, int position) {
