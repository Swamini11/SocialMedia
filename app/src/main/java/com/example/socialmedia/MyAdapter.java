...
public class MyAdapter extends RecyclerView.Adapter<productviewholder> {
    ...
    @Override public productviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(null!=activenetwork){
                    id3 = f1.getUid();
                    FirebaseDatabase.getInstance().getReference().child(holder.t4.getText().toString()+"likes").child("likes").child(id3).setValue("1").addOnCompleteListener(new OnCompleteListener<Void>() {
